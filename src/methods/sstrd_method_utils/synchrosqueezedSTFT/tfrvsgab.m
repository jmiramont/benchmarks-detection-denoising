function [tfr, stfr, lost, q_hatmap, if_hatmap] = tfrvsgab(x, M, L, q_method, if_method, gamma_K, q_threshold)
% [tfr, stfr, lost, q_hatmap, if_hatmap] = tfrvsgab(x, M, L, q_method, if_method, gamma_K, q_threshold)
% Compute the discrete-time vertical synchrosqueezed Gabor Transform
% 
% INPUT:
